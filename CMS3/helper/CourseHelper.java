...
import interfaces.utilities.CourseServices;
...
public class CourseHelper extends CourseDatabase implements CourseServices
{
    private Teacher teacher;
    private Admin admin;
    List<Course> courseList;
    Scanner sc = new Scanner(System.in);
    public CourseHelper(Teacher teacher)
    {

        this.teacher = teacher;
        courseList = super.getCourseList();
    }

    public CourseHelper(Admin admin)
    {
        this.admin = admin;
        courseList = super.getCourseList();
    }
    ...
    @Override
    public List<String> getTeacherCourseList() {
    ...
    @Override
    public List<Course> getCourseListAdmin(Admin admin)
    {
        if(admin!=null)
            return courseList;
        return null;
...
public Course addCourse() throws IOException {
    ...
    {
        System.out.println("Invalid Attempt to Add Course.");
    }
    return null;
}

    @Override
    public void allotCourseToTeacher(String courseID, Teacher teacher) throws IOException {
        if(admin!=null)
        {
           for(Course i: courseList)
           {
