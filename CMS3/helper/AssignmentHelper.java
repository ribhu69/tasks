...
public class AssignmentHelper extends AssignmentDatabase implements AssignmentServices {
    ...
    public AssignmentHelper(Student student)
    {
        this.student = student;
        assignmentList = super.getAssignmentList();
        submittedAssignmentServices = new SubmittedAssignmentHelper(student);
        studentAssignments = submittedAssignmentServices.getSubmittedAssignmentList(student.getStudentID());
    }

    public AssignmentHelper(Teacher teacher)
    {
        this.teacher = teacher;
        assignmentList = super.getAssignmentList();
    }

    public void addAssignment(List<String> teacherCourseList) throws IOException {
        ...
        if(assignmentExists==0)
        {
            ...
            assignmentList = super.updateAssignmentList(assignmentList);
        }
        else
        {
    ...
    public void submitAssignment(List<String> courseList,String studentID) throws IOException {
        ...
        int submittedAssignmentCount = submittedAssignmentCount(courseID);
        ...
        if(assignmentCount>1)
        {
            ...
            getStudentAssignmentList(courseID,student.getStudentID());
                ...
                switch (option)
                {
                    case 1:
                        ...
                        do {
                            ...
                            {
                                submittedAssignmentServices.submitAssignment(courseID,student.getStudentID(),topicNumber);
                                studentAssignments = submittedAssignmentServices.getSubmittedAssignmentList(student.getStudentID());
    ...
    @Override
    public List<StudentAssignment> markAssignment(List<String> teacherCourseLists,List<StudentAssignment> studentAssignments) {
    ...
    private int submittedAssignmentCount(String courseID)
    {
        int count=0;
        for(StudentAssignment i:studentAssignments)
        {
