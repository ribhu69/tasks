...
CourseTopicDatabase{
    ...
    private final String courseTopicDB = "src\\database\\CourseTopicDatabase.csv";
    ...
    public List<Topic> updateCourseTopicList(List<Topic> updatedCourseTopicList) throws IOException {
