...
public class TeacherHelper implements TeacherServices {
    Scanner sc = new Scanner(System.in);
    private List<Teacher> teacherList;

    public TeacherHelper(List<Teacher> teacherList)
    {
...
//found here
    ...
    @Override
    public void updateTeacherAccounts(List<Teacher> teacherList) {
        this.teacherList = teacherList;
    }

    @Override
    public List<Teacher> changeAccountPassword(Teacher teacher) {
        PasswordHelper passwordHelper = new PasswordHelper();
