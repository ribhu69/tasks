...
public class EnrolledCourseHelper implements EnrolledCourseServices
{
    ...
    public EnrolledCourseHelper(List<EnrolledStudent> enrolledStudentList)
    {
    ...
    @Override
    public List<String> getStudentEnrolledCourses(Student student){
    ...
    @Override
    public List<String> getCourseList(Student student) {
...
//                    enrolledStudents = super.updateEnrolledCourseList(enrolledStudents);
    ...
    @Override
    public void updateEnrolledCourses(List<EnrolledStudent> enrolledStudents) {
        this.enrolledStudents = enrolledStudents;
    }
    ...
    ///not complete
    @Override
    public void addStudentToCourse(String courseName, String courseID, int totalClasses,List<Student> studentList)  {

        System.out.println("Size of Student List: "+studentList.size());
           for(Student i:studentList)
           {
               System.out.println("IN IT");
               enrolledStudents.add(new EnrolledStudent(courseName,courseID.toLowerCase(),totalClasses,i.getStudentID(),0));
           }
//           enrolledStudents = super.updateEnrolledCourseList(enrolledStudents);
    }
