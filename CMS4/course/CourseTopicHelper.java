...
public class CourseTopicHelper implements CourseTopicServices {
    private List<Topic> courseTopicList;
    Scanner sc = new Scanner(System.in);
    public CourseTopicHelper(List<Topic> courseTopicList)
    {
    ...
    @Override
    public void addCourseTopics(String courseName, String courseID) {
    ...
    public void addNewCourseTopic(String courseID)  {
...
//            System.out.println("The Count is "+count);
            if( count>0 && count <6 )
            {
                ...
                System.out.println("No course topics exist for Course Id: "+courseID);
    ...
    @Override
    public List<Topic> getCourseTopicList() {
            return courseTopicList;
    }

    @Override
    public void updateCourseTopics(List<Topic> topicList) {
        courseTopicList = topicList;
    }
    ...
    public void changeCourseTopic() throws IOException {
            List<Topic> courseTopicsList = getCourseTopicList();
