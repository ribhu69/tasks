...
public class StudentMarksHelper implements MarksServices {
    private List<CourseMarks> studentMarksList;
    Scanner sc = new Scanner(System.in);

    public StudentMarksHelper(List<CourseMarks> studentMarksList)
    {
    ...
    @Override
    public void modifyCourseMarks(List<String> teacherCourseList, Teacher teacher)  {
...
//            updateDatabase(studentMarksList);
    ...
    @Override
    public void updateStudentMarkList(List<CourseMarks> courseMarksList) {
        this.studentMarksList = courseMarksList;
    }
    ...
    @Override
    public void updateCourseTeacher(String courseID, int teacherID)  {
            for(CourseMarks i:studentMarksList)
            {
